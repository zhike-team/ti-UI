...
var _jsxFileName = 'src/ui/textarea/index.js';
...
var View = function (_Component) {
  ...
  (0, _createClass3.default)(View, [{
    ...
    value: function render() {
      ...
      var realClassName = [_styles2.default.textarea];
      realClassName = realClassName.concat(className instanceof Array ? className : [className]);

      return _react2.default.createElement('textarea', (0, _extends3.default)({}, this.props, {
